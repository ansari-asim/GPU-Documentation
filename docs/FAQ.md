---
title: FAQ
description: Frequently asked questions about camera config, bandwidth, GPU connectivity, and security.
tags:
  - faq
  - camera
  - bandwidth
...
Answers to the most common questions about hardware compatibility, camera configuration, connectivity, and security certifications.
...
## GPU Connectivity { #gpu-connectivity }
...
|----------------|---------|
| Cloud-based | Fully managed, remote inference |
| Edge-based | On-premise, low-latency processing |
